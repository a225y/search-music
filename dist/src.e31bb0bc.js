...
},{"./img/logo.gif":[["logo.969f1172.gif","img/logo.gif"],"img/logo.gif"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"validation.js":[function(require,module,exports) {
"use strict";
...
function showAlert() {
  var alert = document.querySelector('.erro-alert');
...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"../node_modules/fetch-jsonp/build/fetch-jsonp.js":[function(require,module,exports) {
var define;
...
function fetchMusic(e) {
  if (e.keyCode === 13) {
    ...
    //若未輸入彈出提示框
    if ((0, _validation.isEmpty)(keyWord)) {
      (0, _validation.showAlert)();
      return;
    }
    var fetchUrl = "https://itunes.apple.com/search?term=".concat(keyWord, "&limit=25");
...
var musicInfo = document.querySelector('tbody');
function showMusic(musics) {
  ...
  for (var i = 0; i < musics.length; i++) {
    ...
    tr.innerHTML = "\n            <th scope=\"row\">\n                <span class=\"album\">\n                    <img src=\"".concat(info.artworkUrl100, "\">\n                </span>\n            </th>\n            <td  style=\"padding-left: 10px\"> ").concat(info.trackName, " </td>\n            <td> ").concat(info.artistName, "</td>\n            <td> ").concat(info.collectionName, "</td>\n            <td style=\" text-align: center\"><audio src=\"").concat(info.previewUrl, "\"controls></audio></td>\n            <td><p><a href=\"").concat(info.collectionViewUrl, "\" target=\"blank\">\u5B8C\u6574\u7248</a></p></td>\n        ");
...
// });
},{"./styles.css":"styles.css","./validation.js":"validation.js","bootstrap":"../node_modules/bootstrap/dist/js/bootstrap.esm.js","fetch-jsonp":"../node_modules/fetch-jsonp/build/fetch-jsonp.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
